...
# Object Files
OBJECTFILES= \
	${OBJECTDIR}/ForLoopsTotalAndAverage2.o
...
${OBJECTDIR}/ForLoopsTotalAndAverage2.o: ForLoopsTotalAndAverage2.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/ForLoopsTotalAndAverage2.o ForLoopsTotalAndAverage2.cpp
